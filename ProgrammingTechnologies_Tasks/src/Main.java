...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Task 1");
		int bella = 5;
		System.out.println("Result: " + Tasks6.bell(bella));
		
		System.out.println("Task 2");
		String englishword = "Button";
		String englishtext = "Do you think it is going to rain today?";
		System.out.println("Result: " + Tasks6.translateWord(englishword));
		Tasks6.translateSentence(englishtext);
		
		System.out.println("Task 3");
		String rgbstring = "rgb(123,0,56)";
		String rgbstring1 = "rgba(255,168,3,0.5)";
		System.out.println("Result: " + Tasks6.validColor(rgbstring));
		System.out.println("Result2: " + Tasks6.validColor(rgbstring1));
		
		System.out.println("Task 4");
		String url = "https://edabit.com?a=1&a=3&b=2&a=2&c=3&d=10&b=19&a=4&e=4";
		String[] paramsToStrip = {"c", "d", "e"};
		System.out.println("Result: ");
		Tasks6.stripUrlParams(url);
		System.out.println("Result: ");
		Tasks6.stripUrlParams(url, paramsToStrip);
		
		System.out.println("Task 5");
		String title = "system dddddd fffff ggggg ffff";
		System.out.println("Result: ");
		Tasks6.getHashTags(title);
		
		System.out.println("Task 6");
		int ulamdigit = 11;
		System.out.println("Result: " + Tasks6.ulam(ulamdigit));
		
		System.out.println("Task 7");
		String string2 = "adzbcabcwdaf";
		System.out.println("Result: " + Tasks6.longestNonrepeatingSubstring(string2));
		
		System.out.println("Task 8");
		int arabdig = 51;
		System.out.println("Result: " + Tasks6.convertToRoman(arabdig));
		
		System.out.println("Task 9");
		String formul = "  / 2                 4  =    0";
		System.out.println("Result: " + Tasks6.formula(formul));
		
		System.out.println("Task 10");
		int digit10 = 123457891;
		System.out.println("Result: " + Tasks6.palindromeDescendant(digit10));
		break;
		}
